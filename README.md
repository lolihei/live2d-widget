...
| 选项 | 类型 | 默认值 | 说明 |
| - | - | - | - |
| `waifuPath` | `string` | `https://gcore.jsdelivr.net/gh/lolihei/live2d-widget@latest/waifu-tips.json` | 看板娘资源路径，可自行修改 |
| `apiPath` | `string` | `https://live2d.fghrsh.net/api/` | API 路径，可选参数 |
| `cdnPath` | `string` | `https://gcore.jsdelivr.net/gh/fghrsh/live2d_api/` | CDN 路径，可选参数 |
